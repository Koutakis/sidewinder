...
config = Model(
    ...
    columns=[
        ...
        PostgresColumn(name="FRAM_GILTIG_FOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="FRAM_GILTIG_TOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="FRAM_ID", data_type=PostgresType.TEXT),
        PostgresColumn(name="FRAM_ID_TEXT", data_type=PostgresType.TEXT),
        PostgresColumn(name="FRAM_PASSIV", data_type=PostgresType.BOOLEAN),
        PostgresColumn(name="FRAM_TEXT", data_type=PostgresType.TEXT),
        ...
        PostgresColumn(name="ITGRP_GILTIG_FOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="ITGRP_GILTIG_TOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="ITGRP_ID", data_type=PostgresType.TEXT),
        PostgresColumn(name="ITGRP_ID_TEXT", data_type=PostgresType.TEXT),
        PostgresColumn(name="ITGRP_PASSIV", data_type=PostgresType.BOOLEAN),
        PostgresColumn(name="ITGRP_TEXT", data_type=PostgresType.TEXT),
...
def execute(env: EnvConfig, cfg=config):
	...
	COALESCE([FRAM_GILTIG_FOM], '1899-12-31 00:00:00') AS FRAM_GILTIG_FOM,
	COALESCE([FRAM_GILTIG_TOM], '1899-12-31 00:00:00') AS FRAM_GILTIG_TOM,
	[FRAM_ID] AS FRAM_ID,
	[FRAM_ID_TEXT] AS FRAM_ID_TEXT,
	[FRAM_PASSIV] AS FRAM_PASSIV,
	[FRAM_TEXT] AS FRAM_TEXT,
	...
	COALESCE([ITGRP_GILTIG_FOM], '1899-12-31 00:00:00') AS ITGRP_GILTIG_FOM,
	COALESCE([ITGRP_GILTIG_TOM], '1899-12-31 00:00:00') AS ITGRP_GILTIG_TOM,
	[ITGRP_ID] AS ITGRP_ID,
	[ITGRP_ID_TEXT] AS ITGRP_ID_TEXT,
	[ITGRP_PASSIV] AS ITGRP_PASSIV,
	[ITGRP_TEXT] AS ITGRP_TEXT,
    ...
    FROM [utdata].[utdata294].[EK_DIM_OBJ_KONTO]
