...
config = Model(
    ...
    columns=[
        ...
        PostgresColumn(name="COGNCO_GILTIG_FOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="COGNCO_GILTIG_TOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="COGNCO_ID", data_type=PostgresType.TEXT),
        PostgresColumn(name="COGNCO_ID_TEXT", data_type=PostgresType.TEXT),
        PostgresColumn(name="COGNCO_PASSIV", data_type=PostgresType.BOOLEAN),
        PostgresColumn(name="COGNCO_TEXT", data_type=PostgresType.TEXT),
...
def execute(env: EnvConfig, cfg=config):
	...
	COALESCE([COGNCO_GILTIG_FOM], '1899-12-31 00:00:00') AS COGNCO_GILTIG_FOM,
	COALESCE([COGNCO_GILTIG_TOM], '1899-12-31 00:00:00') AS COGNCO_GILTIG_TOM,
	[COGNCO_ID] AS COGNCO_ID,
	[COGNCO_ID_TEXT] AS COGNCO_ID_TEXT,
	[COGNCO_PASSIV] AS COGNCO_PASSIV,
	[COGNCO_TEXT] AS COGNCO_TEXT,
    ...
    FROM [utdata].[utdata802].[EK_DIM_OBJ_KTO]
