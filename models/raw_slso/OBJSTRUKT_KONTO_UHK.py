...
config = Model(
    name="objstrukt_konto_uhk",
    source_entity="OBJSTRUKT_KONTO_UHK",
    table="objstrukt_konto_uhk",
    ...
    columns=[
        ...
        PostgresColumn(name="OBJ_UHK", data_type=PostgresType.TEXT),
    ],
...
def execute(env, cfg=config):
    query=f"""SELECT * FROM (SELECT
    	...
    	[OBJ_UHK] AS OBJ_UHK
    FROM [udpb4].[udpb4_100].[OBJSTRUKT_KONTO_UHK]) y
    WHERE 1=1"""
