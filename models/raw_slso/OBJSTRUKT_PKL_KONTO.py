...
config = Model(
    name="objstrukt_pkl_konto",
    source_entity="OBJSTRUKT_PKL_KONTO",
    table="objstrukt_pkl_konto",
    ...
    columns=[
        ...
        PostgresColumn(name="OBJ_PKL", data_type=PostgresType.TEXT),
    ],
...
def execute(env, cfg=config):
    query=f"""SELECT * FROM (SELECT
    	...
    	[OBJ_PKL] AS OBJ_PKL
    FROM [udpb4].[udpb4_100].[OBJSTRUKT_PKL_KONTO]) y
    WHERE 1=1"""
