...
config = Model(
    ...
    columns=[
        ...
        PostgresColumn(name="PROJA_GILTIG_FOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="PROJA_GILTIG_TOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="PROJA_ID", data_type=PostgresType.TEXT),
        PostgresColumn(name="PROJA_ID_TEXT", data_type=PostgresType.TEXT),
        PostgresColumn(name="PROJA_PASSIV", data_type=PostgresType.BOOLEAN),
        PostgresColumn(name="PROJA_TEXT", data_type=PostgresType.TEXT),
        PostgresColumn(name="PROJT_GILTIG_FOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="PROJT_GILTIG_TOM", data_type=PostgresType.TIMESTAMPTZ),
        PostgresColumn(name="PROJT_ID", data_type=PostgresType.TEXT),
        PostgresColumn(name="PROJT_ID_TEXT", data_type=PostgresType.TEXT),
        PostgresColumn(name="PROJT_PASSIV", data_type=PostgresType.BOOLEAN),
        PostgresColumn(name="PROJT_TEXT", data_type=PostgresType.TEXT),
    ],
...
def execute(env: EnvConfig, cfg=config):
    ...
    FROM [raindance_udp].[udp_150].[EK_DIM_OBJ_PROJ]
