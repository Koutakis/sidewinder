...
config = Model(
    ...
    source_entity="RK_DIM_TAB_MILJÖ",
    table="rk_dim_tab_miljö",
    ...
    columns=[
        ...
        PostgresColumn(name="TAB_MILJÖ", data_type=PostgresType.TEXT),
        PostgresColumn(name="TAB_MILJÖ_ID_TEXT", data_type=PostgresType.TEXT),
        PostgresColumn(name="TAB_MILJÖ_TEXT", data_type=PostgresType.TEXT),
    ],
